...
use App\Models\Platform\System\Menu\Category;
...
class UserController extends BaseController
{
  ...
  public function router(Request $request)
  {
    try
    {
      ...
      // 平台菜单redis Key
      $key = Parameter::REDIS_PLATFORM_ROUTER;
      ...
      else
      {
        ...
        // 获取用户可访问菜单
        $result = Menu::getCurrentUserRouterData($menu_ids);
  ...
  public function navigation(Request $request)
  {
    try
    {
      ...
      // 平台菜单redis Key
      $key = Parameter::REDIS_PLATFORM_NAVIGATION;
      ...
      else
      {
        ...
        // 获取用户可访问菜单
        $result = Category::getCurrentUserNavigationData($menu_ids);
  ...
  public function menu(Request $request)
  {
    try
    {
      ...
      // 平台菜单redis Key
      $key = Parameter::REDIS_PLATFORM_MENU;
      ...
      else
      {
        ...
        // 获取用户可访问菜单
        $result = Category::getCurrentUserMenuData($menu_ids);
