 ...
 * 班级导出类
 */
class SquadExport implements FromView, WithEvents
{
  protected $data = null;
  ...
  {
      return view('/export/squad', ['data'=>$this->data]);
  }

  public function registerEvents(): array
  {
    $business_license = $this->data['organization']['business_license'];
    ...
    if(!empty($business_license))
    {
      return [
        ...
        {
          $this->setImage2Excel($event, 'A3', $business_license, 130, 440);
        }
      ];
    }
