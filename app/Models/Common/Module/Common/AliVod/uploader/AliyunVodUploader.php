...
class AliyunVodUploader
{
    ...
    private function createUploadImage($uploadImageRequest)
    {
        ...
        // AliyunVodLog::printLog("CreateUploadImage, FilePath: %s, ImageId: %s, ImageURL: %s",$uploadImageRequest->getFilePath(), $data->ImageId, $data->ImageURL);
        return $data;
    }
    ...
    private function createUploadAttachedMedia($uploadAttachedRequest)
    {
        ...
        // AliyunVodLog::printLog("CreateUploadAttachedMedia, FilePath: %s, MediaId: %s, MediaURL: %s", $uploadAttachedRequest->getFilePath(), $data->MediaId, $data->MediaURL);
        return $data;
    }
    ...
    private function uploadOssObject($filePath, $object, $uploadInfo, $headers=null)
    {
        ...
        // AliyunVodLog::printLog("UploadFile %s Finish, MediaId: %s, FilePath: %s, Destination: %s/%s", $uploadInfo->MediaType, $uploadInfo->MediaId, $filePath, $bucketHost, $object);
    }
